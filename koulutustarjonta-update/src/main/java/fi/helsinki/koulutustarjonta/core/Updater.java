...
public class Updater {
    ...
    public Updater(TarjontaClient tarjontaClient, LearningOpportunityDAO learningOpportunityDAO, ApplicationOptionDAO applicationOptionDAO, ApplicationSystemDAO applicationSystemDAO) {
