...
public class BindUtil {
    ...
    public static void bindI18N(SQLStatement q, String fieldPrefix, I18N i18n) {
        ...
        q.bind(String.format("%s_fi", fieldPrefix), optionalI18n.orElse(EMPTY_I18N).getFi());
        q.bind(String.format("%s_sv", fieldPrefix), optionalI18n.orElse(EMPTY_I18N).getSv());
        q.bind(String.format("%s_en", fieldPrefix), optionalI18n.orElse(EMPTY_I18N).getEn());
    }
