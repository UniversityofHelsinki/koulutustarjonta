...
LOB (TAVOITTEET_SV) STORE AS (
  ...
  NOCACHE
  LOGGING)
LOB (KUVAUSTUTKINTO_FI) STORE AS (
  TABLESPACE  USERS
  ENABLE      STORAGE IN ROW
  CHUNK       8192
  RETENTION
  NOCACHE
  LOGGING)
LOB (KUVAUSTUTKINTO_EN) STORE AS (
  TABLESPACE  USERS
  ENABLE      STORAGE IN ROW
  CHUNK       8192
  RETENTION
  NOCACHE
  LOGGING)
LOB (KUVAUSTUTKINTO_SV) STORE AS (
  TABLESPACE  USERS
  ENABLE      STORAGE IN ROW
  CHUNK       8192
  RETENTION
